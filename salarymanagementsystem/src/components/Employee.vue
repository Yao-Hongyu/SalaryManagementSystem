    ...
    <div>
        <el-card class="main_card">
            ...
            >
                ...
                <el-table-column prop="employeeTypeId" label="employeeTypeId">
                </el-table-column>
        ...
        >
            <el-form :model="employee">
                <el-form-item label="id" v-if="editStatus">
                    <el-input v-model="employee.id" :disabled="true"></el-input>
                </el-form-item>
                ...
                <el-form-item label="employeeTypeId">
                  <el-input v-model="employee.employeeTypeId"></el-input>
                </el-form-item>
                <el-form-item>
...
export default {
    ...
    methods: {
        ...
        remove(id) {
            this.$confirm("Are you sure?", "Tip", {
                ...
                .then(() => {
                    ...
                    this.employee.id = id;
                    this.$http
                        .post("/employee/delete", this.employee)
                        .then((res) => {
                            res = res.data;
                            if (res.code != "0000")
        ...
        upload() {
            console.log("upload");
            this.$http
                .post("/employee/add", this.employee)
                .then((res) => {
                    res = res.data;
                    if (res.code != "0000")
                        return this.$message.error(res.message);
